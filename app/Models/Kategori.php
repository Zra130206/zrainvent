...
class Kategori extends Model
{
    ...
    public static function getKategoriAll(){
        return DB::table('kategori')
                    ->select('kategori.id','deskripsi',DB::raw('infoKategori(kategori) as infokategori'));
    }
    ...
    public static function katShowAll(){
        return DB::table('kategori')
                ...
                ->select('kategori.id','deskripsi',DB::raw('infoKategori(kategori) as ketkategori'),
                         'barang.merk');
                // ->pagination(1);
                // ->get();
    ...
    public static function showKategoriById($id){
        return DB::table('kategori')
                ->join('barang','kategori.id','=','barang.kategori_id')
                ->select('barang.id','kategori.deskripsi',DB::raw('infoKategori(kategori.kategori) as ketkategori'),
